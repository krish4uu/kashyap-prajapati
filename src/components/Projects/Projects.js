        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Secrets"
              description="The app is all about the web application where you submit your secrets and you can also see other secrets without knowing their names. App is focused on getting the user data and storing them into the database with hashing functionality.
