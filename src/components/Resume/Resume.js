...
function Resume() {
  ...
  return (
    <Container fluid className="resume-section">
      <Particle />
      <Container>
        <Row style={{ justifyContent: "center", position: "relative", margin:30 }}>
        ...
        <Row className="resume">
          ...
          <Tilt>
            ...
            <Resumecontent
              title="JUNIOR WEB DEVELOPER [ AKAR ENTERPRISE ]"
              date="June 2019 - DECEMBER 2019"
              content={[
                "Designed and developed dynamic ecommerce website to buy and sell Hardware and Home appliance using HTML, CSS, JavaScript, Bootstrap.",
